            ...
            <div class="d-flex flex-column form shadow p-4 gap-2">
                ...
                <div class="mb-4">
                    ...
                    <input class="form-control" type="date" name="fechaInicial"
                        id="fechaInicial" placeholder="Ingrese una fechaInicial" value="">
                ...
                <div class="mb-4">
                    ...
                    <input class="form-control" type="date" name="fechaFinal"
                        id="fechaFinal" placeholder="Ingrese una fechaFinal" value="">
                ...
                <div class="mb-4">
                    ...
                    <input class="form-control" type="decimal" name="valorMora"
                        id="valorMora" placeholder="Ingrese una valorMora" value="">
                ...
                <div class="mb-4">
                    ...
                    <input class="form-control" type="text" name="observaciones"
                        id="observaciones" placeholder="Ingrese una observaciones" value="">
